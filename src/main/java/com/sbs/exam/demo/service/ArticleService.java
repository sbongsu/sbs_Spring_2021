...
public class ArticleService {
	...
	public ResultData increaseGoodReactionPoint(int relId) {
		...
		return ResultData.from("S-1", "좋아요수가 증가되었습니다.", "affectedRowsCount", affectedRowsCount);
	}
	...
	public ResultData increaseBadReactionPoint(int relId) {
		...
		return ResultData.from("S-1", "싫어요수가 증가되었습니다.", "affectedRowsCount", affectedRowsCount);
