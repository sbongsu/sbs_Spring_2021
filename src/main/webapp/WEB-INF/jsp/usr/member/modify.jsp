      ...
      <table class="border-collapse border-2 border-gray-500">
        <tbody>
          ...
          <tr>
            <th>닉네임</th>
            <td>
              <input name="nickname" type="text" class="w-96 input input-bordered" value="${rq.loginedMember.nickname }" placeholder="닉네임을 입력해주세요"/>
            </td>
          </tr>
          <tr>
            <th>새 비밀번호</th>
          ...
          <tr>
            <th>새 비밀번호 확인</th>
            <td>
              <input name="loginPwConfirm" type="password" class="w-96 input input-bordered" placeholder="새 비밀번호를 한번 더 입력해주세요" />
            </td>
          </tr>
          <tr>
            <th>이메일</th>
            <td>
              <input name="email" type="text" class="w-96 input input-bordered" value="${rq.loginedMember.email }" placeholder="이메일을 입력해주세요"/>
            </td>
          </tr>
          <tr>
            <th>휴대전화번호</th>
